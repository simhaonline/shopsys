            ...
            'data' => [
                'transports' => [
                    [
                        ...
                        'images' => [
                            ['url' => $this->overwriteDomainUrl . '/content-test/images/transport/default/56.jpg'],
                            ['url' => $this->overwriteDomainUrl . '/content-test/images/transport/original/56.jpg'],
                        ],
                        'payments' => [
                    ...
                    [
                        ...
                        'images' => [
                            ['url' => $this->overwriteDomainUrl . '/content-test/images/transport/default/57.jpg'],
                            ['url' => $this->overwriteDomainUrl . '/content-test/images/transport/original/57.jpg'],
                        ],
                        'payments' => [
                    ...
                    [
                        ...
                        'images' => [
                            ['url' => $this->overwriteDomainUrl . '/content-test/images/transport/default/58.jpg'],
                            ['url' => $this->overwriteDomainUrl . '/content-test/images/transport/original/58.jpg'],
                        ],
                        'payments' => [
                            ['name' => t('Credit card', [], 'dataFixtures', $this->getLocaleForFirstDomain())],
