            ...
            'data' => [
                'payments' => [
                    [
                        ...
                        'images' => [
                            ['url' => $this->overwriteDomainUrl . '/content-test/images/payment/default/53.jpg'],
                            ['url' => $this->overwriteDomainUrl . '/content-test/images/payment/original/53.jpg'],
                        ],
                        'transports' => [
                    ...
                    [
                        ...
                        'images' => [
                            ['url' => $this->overwriteDomainUrl . '/content-test/images/payment/default/55.jpg'],
                            ['url' => $this->overwriteDomainUrl . '/content-test/images/payment/original/55.jpg'],
                        ],
                        'transports' => [
                    ...
                    [
                        ...
                        'images' => [
                            ['url' => $this->overwriteDomainUrl . '/content-test/images/payment/default/54.jpg'],
                            ['url' => $this->overwriteDomainUrl . '/content-test/images/payment/original/54.jpg'],
                        ],
                        'transports' => [
                            ['name' => t('Personal collection', [], 'dataFixtures', $this->getLocaleForFirstDomain())],
                        ],
